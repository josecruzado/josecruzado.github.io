    ...
    return <>
        <div className="flex items-center justify-center h-screen bg-gradient-to-br">
            <div className="bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 max-w-xs">
                <img className="mb-3 w-32 h-32 rounded-full shadow-lg mx-auto"  src="./memoji_jose.png" alt="product designer"></img>
                <h1 className="text-lg text-gray-700"> Jose Cruzado </h1>
                <h3 className="text-sm text-gray-400 "> Software developer </h3>
                <p className="text-xs text-gray-400 mt-3 mb-5  text-justify" > I am a person who strives to achieve what I set out to do and passionate about technology. I have experience as a Full-Stack developer with more backend leaning. I have developed systems using Angular and SpringMVC frameworks.</p>
